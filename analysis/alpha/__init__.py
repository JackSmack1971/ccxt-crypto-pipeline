...
from .evaluation import (CandidateResult, Hypothesis, HypothesisRegistry, SplitResult,
                         apply_bh_fdr, apply_holm, build_split, descriptive_baseline, baseline_families,
                         rank_candidates, score_candidate, validate_temporal_alignment, baseline_comparison)
...
__all__ = [
    ...
    "CandidateResult", "Hypothesis", "HypothesisRegistry", "SplitResult", "apply_bh_fdr",
    "apply_holm", "build_split", "descriptive_baseline", "baseline_families", "baseline_comparison", "rank_candidates", "score_candidate",
    "validate_temporal_alignment", "phase2_strategy_spec", "research_report", "write_research_run",
]
